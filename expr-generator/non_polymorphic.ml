    ...
    fun (type a) (e : a expr) : string ->
     ...
     | List l ->
       ...
       ^ List.foldi
           ...
           l
       ^ "])"
     | Cons (l, r) -> Printf.sprintf "(%s::%s)" (to_string_helper l) (to_string_helper r)
     ...
     | Plus (l, r) -> Printf.sprintf "(%s + %s)" (to_string_helper l) (to_string_helper r)
     | Minus (l, r) ->
       Printf.sprintf "(%s - %s)" (to_string_helper l) (to_string_helper r)
     | Mult (l, r) -> Printf.sprintf "(%s * %s)" (to_string_helper l) (to_string_helper r)
     | Plus_dot (l, r) ->
       Printf.sprintf "(%s +. %s)" (to_string_helper l) (to_string_helper r)
     | Minus_dot (l, r) ->
       Printf.sprintf "(%s -. %s)" (to_string_helper l) (to_string_helper r)
     ...
     | And (l, r) -> Printf.sprintf "(%s && %s)" (to_string_helper l) (to_string_helper r)
     | Or (l, r) -> Printf.sprintf "(%s || %s)" (to_string_helper l) (to_string_helper r)
